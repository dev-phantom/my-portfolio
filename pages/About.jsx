...
const About = () => {
    return ( 
        <div className="bg-bgColor w-full pb-8 text-white">
            ...
            <h1 className="font-semibold text-4xl py-10 text-center">About-<span className="text-primary">me</span></h1>
            <div className="w-full flex justify-center items-center ">
                <p className=" bg-altBg w-[80%] font-semibold text-xl p-12 rounded-lg leading-[40px]">
