  ...
  return (
    <div className=" w-full pb-8 text-white ">
          ...
          return (
            <div className="card px-5 mx-auto mt-10 " key={items.id}>
              <div className="absolute right-[-20px] top-[-55px] lg:right-[-6rem]lg:top-12 bg-altBg w-[60%] md:w-[40%] p-2 rounded-lg">
                ...
                <h1 className="text-md capitalize leading-[25px] md:leading-[35px] py-1 md:py-3">
                  <span className="text-primary">{items.name}</span> -{" "}
                  {items.purpose}
                </h1>
      ...
      <div className="flex justify-center items-center pb-10 pt-20">
        <button
          className="bg-primary px-20 py-4 text-[#000000] font-semibold rounded-xl"
          onClick={handleGit}
        >
          More Projects
        </button>
