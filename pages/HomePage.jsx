    ...
    return ( 
        <div className="bg-bgColor w-full h-screen text-white">
            ...
            <main className='w-full flex justify-between items-center px-10 py-10 '>
                ...
                <div className='w-1/2 pl-40 pt-10 flex items-center justify-center'>
