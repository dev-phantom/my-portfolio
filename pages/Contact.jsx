...
const Contact = () => {
  ...
  return (
    <div className="w-full text-white">
      ...
      <h1 className="font-Ubuntu pt-6 text-primary font-bold text-[25px] text-center">
        GET IN TOUCH
      </h1>
      <h4 className="font-Ubuntu text-textColor text-[17px] py-2 font-normal text-center">
        ...
        <div className="w-full lg:w-1/2 flex justify-center items-center">
          <form onSubmit={handleSubmit}>
            <div className="mt-5">
              <label
                htmlFor=""
                className="capitalize text-primary font-bold text-[17px] font-Nunito not-italic leading-9"
              >
                Full Name
              </label>
              <input
            ...
            <div className="mt-8">
              <button
                className="bg-primary w-full py-3 text-bgColor rounded-lg"
                type="submit"
              >
                Send
              </button>
